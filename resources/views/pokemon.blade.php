...
<div class="container">
    ...
    <section class="WELCOMEsECTION">
        ...
        <div class="pet">
            <img style="width: 90%;" src="{{ asset('uploads/40.png') }}" alt="Welcome Pet" />
        </div>
    </section>
    ...
    <div class="petsSelection">
        <div class="photo-grid">
            <h2>Adoptable Pokemons</h2>
            <p>Find your next best friend among our adorable pets!</p>
            @if($pets->isEmpty())
                <p style="color: red;">No Pokemons found matching your search.</p>
            @endif
            <div class="grid"></div>
        </div>
    </div>
